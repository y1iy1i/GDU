...
项目已经完成三次提问驱动生长：财务数字闭合、论文来源冲突和国家标准规范合规判断。三者共用同一个通用晋升事务层。当前全仓测试结果为 `241 passed, 5 skipped`。
...
- `src/gdu/builder_v1/`：统一 Evidence Block、来源验证、最小 Document Map，以及带原文引文、Context、语义角色、模态和可计算比较约束的 Representation Candidate 编译；
