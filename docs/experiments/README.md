...
- `GDU_BUILDER_V1_REPRESENTATION_BLIND_02_SETUP.md`：未见问题族变体、来源/控制案例分层、冻结哈希和运行约束。
- `GDU_BUILDER_V1_REPRESENTATION_BLIND_02_REPORT.md`：原始9/13、逐项审计、去除校验冗余后的11/13离线重放及剩余结构缺口。
